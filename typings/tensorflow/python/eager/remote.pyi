...
def connect_to_cluster(cluster_spec_or_resolver: Any, job_name: str = ..., task_index: int = ..., protocol: Optional[Any] = ..., make_master_device_default: bool = ..., cluster_device_filters: Optional[Any] = ...) -> None: ...
