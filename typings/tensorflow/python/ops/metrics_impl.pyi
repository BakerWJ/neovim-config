...
def auc(labels: Any, predictions: Any, weights: Optional[Any] = ..., num_thresholds: int = ..., metrics_collections: Optional[Any] = ..., updates_collections: Optional[Any] = ..., curve: str = ..., name: Optional[Any] = ..., summation_method: str = ..., thresholds: Optional[Any] = ...): ...
