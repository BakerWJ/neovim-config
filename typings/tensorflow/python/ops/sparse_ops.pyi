...
from tensorflow.python.util import compat as compat, deprecation as deprecation, dispatch as dispatch, tf_inspect as tf_inspect
...
def from_dense(tensor: Any, name: Optional[Any] = ...): ...
...
def sparse_concat(axis: Any, sp_inputs: Any, name: Optional[Any] = ..., expand_nonconcat_dim: bool = ..., concat_dim: Optional[Any] = ..., expand_nonconcat_dims: Optional[Any] = ...): ...
def sparse_concat_v2(axis: Any, sp_inputs: Any, expand_nonconcat_dims: bool = ..., name: Optional[Any] = ...): ...
def sparse_add(a: Any, b: Any, threshold: Optional[Any] = ..., thresh: Optional[Any] = ...): ...
def sparse_add_v2(a: Any, b: Any, threshold: int = ...): ...
...
def sparse_split_v2(sp_input: Optional[Any] = ..., num_split: Optional[Any] = ..., axis: Optional[Any] = ..., name: Optional[Any] = ...): ...
...
def sparse_reduce_max_v2(sp_input: Any, axis: Optional[Any] = ..., keepdims: Optional[Any] = ..., output_is_sparse: bool = ..., name: Optional[Any] = ...): ...
...
def sparse_reduce_sum_v2(sp_input: Any, axis: Optional[Any] = ..., keepdims: Optional[Any] = ..., output_is_sparse: bool = ..., name: Optional[Any] = ...): ...
...
def sparse_tensor_to_dense(sp_input: Any, default_value: Optional[Any] = ..., validate_indices: bool = ..., name: Optional[Any] = ...): ...
...
def sparse_merge_impl(sp_ids: Any, sp_values: Any, vocab_size: Any, name: Optional[Any] = ..., already_sorted: bool = ...): ...
...
def serialize_sparse_v2(sp_input: Any, out_type: Any = ..., name: Optional[Any] = ...): ...
def serialize_many_sparse(sp_input: Any, name: Optional[Any] = ..., out_type: Any = ...): ...
def serialize_many_sparse_v2(sp_input: Any, out_type: Any = ..., name: Optional[Any] = ...): ...
...
class _UnaryMapValueDispatcher(dispatch.OpDispatcher):
    def __init__(self, original_func: Any) -> None: ...
