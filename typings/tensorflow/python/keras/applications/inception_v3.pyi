...
def InceptionV3(include_top: bool = ..., weights: str = ..., input_tensor: Optional[Any] = ..., input_shape: Optional[Any] = ..., pooling: Optional[Any] = ..., classes: int = ..., classifier_activation: str = ...): ...
def conv2d_bn(x: Any, filters: Any, num_row: Any, num_col: Any, padding: str = ..., strides: Any = ..., name: Optional[Any] = ...): ...
