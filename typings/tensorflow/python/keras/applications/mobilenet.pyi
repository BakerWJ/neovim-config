...
def MobileNet(input_shape: Optional[Any] = ..., alpha: float = ..., depth_multiplier: int = ..., dropout: float = ..., include_top: bool = ..., weights: str = ..., input_tensor: Optional[Any] = ..., pooling: Optional[Any] = ..., classes: int = ..., classifier_activation: str = ..., **kwargs: Any): ...
