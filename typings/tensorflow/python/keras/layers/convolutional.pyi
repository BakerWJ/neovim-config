...
class Conv2DTranspose(Conv2D):
    output_padding: Any = ...
    def __init__(self, filters: Any, kernel_size: Any, strides: Any = ..., padding: str = ..., output_padding: Optional[Any] = ..., data_format: Optional[Any] = ..., dilation_rate: Any = ..., activation: Optional[Any] = ..., use_bias: bool = ..., kernel_initializer: str = ..., bias_initializer: str = ..., kernel_regularizer: Optional[Any] = ..., bias_regularizer: Optional[Any] = ..., activity_regularizer: Optional[Any] = ..., kernel_constraint: Optional[Any] = ..., bias_constraint: Optional[Any] = ..., **kwargs: Any) -> None: ...
    input_spec: Any = ...
    kernel: Any = ...
    bias: Any = ...
    built: bool = ...
...
class UpSampling2D(Layer):
    ...
    interpolation: Any = ...
    input_spec: Any = ...
    def __init__(self, size: Any = ..., data_format: Optional[Any] = ..., interpolation: str = ..., **kwargs: Any) -> None: ...
    def compute_output_shape(self, input_shape: Any): ...
    def call(self, inputs: Any): ...
    def get_config(self): ...
