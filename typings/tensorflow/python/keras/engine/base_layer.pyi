...
from tensorflow.python.eager import context as context, execute as execute, function as function, monitoring as monitoring
from tensorflow.python.framework import auto_control_deps as auto_control_deps, constant_op as constant_op, dtypes as dtypes, errors as errors, func_graph as func_graph, ops as ops, sparse_tensor as sparse_tensor, tensor_spec as tensor_spec, tensor_util as tensor_util
...
from tensorflow.python.util import compat as compat, deprecation as deprecation, nest as nest, object_identity as object_identity, tf_inspect as tf_inspect
...
class TensorFlowOpLayer(Layer):
    ...
    constants: Any = ...
    built: bool = ...
    def __init__(self, node_def: Any, name: Any, constants: Optional[Any] = ..., trainable: bool = ..., dtype: Optional[Any] = ...) -> None: ...
    def call(self, inputs: Any): ...
    def get_config(self): ...

class AddLoss(Layer):
    unconditional: Any = ...
    def __init__(self, unconditional: Any, **kwargs: Any) -> None: ...
    def call(self, inputs: Any): ...
    def get_config(self): ...
...
class AddMetric(Layer):
    aggregation: Any = ...
    metric_name: Any = ...
    def __init__(self, aggregation: Optional[Any] = ..., metric_name: Optional[Any] = ..., **kwargs: Any) -> None: ...
    def call(self, inputs: Any): ...
    def get_config(self): ...
