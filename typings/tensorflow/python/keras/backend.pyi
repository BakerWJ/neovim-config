...
from tensorflow.python.framework import composite_tensor as composite_tensor, config as config, constant_op as constant_op, func_graph as func_graph, ops as ops, sparse_tensor as sparse_tensor, tensor_shape as tensor_shape, tensor_util as tensor_util
from tensorflow.python.keras import backend_config as backend_config
from tensorflow.python.ops import array_ops as array_ops, clip_ops as clip_ops, control_flow_ops as control_flow_ops, control_flow_util as control_flow_util, functional_ops as functional_ops, image_ops as image_ops, init_ops as init_ops, linalg_ops as linalg_ops, logging_ops as logging_ops, math_ops as math_ops, nn as nn, random_ops as random_ops, sparse_ops as sparse_ops, state_ops as state_ops, tensor_array_grad as tensor_array_grad, tensor_array_ops as tensor_array_ops
...
from tensorflow.python.util import nest as nest, object_identity as object_identity, tf_contextlib as tf_contextlib, tf_inspect as tf_inspect
...
def eager_learning_phase_scope(value: Any) -> None: ...
def get_session(op_input_list: Any = ...): ...
def get_graph(): ...
...
def unique_object_name(name: Any, name_uid_map: Optional[Any] = ..., avoid_names: Optional[Any] = ..., namespace: str = ..., zero_based: bool = ...): ...
def constant(value: Any, dtype: Optional[Any] = ..., shape: Optional[Any] = ..., name: Optional[Any] = ...): ...
def is_keras_tensor(x: Any): ...
def placeholder(shape: Optional[Any] = ..., ndim: Optional[Any] = ..., dtype: Optional[Any] = ..., sparse: bool = ..., name: Optional[Any] = ..., ragged: bool = ...): ...
def is_placeholder(x: Any): ...
def freezable_variable(value: Any, shape: Optional[Any] = ..., name: Optional[Any] = ...): ...
def shape(x: Any): ...
def int_shape(x: Any): ...
def ndim(x: Any): ...
def dtype(x: Any): ...
...
def batch_normalization(x: Any, mean: Any, var: Any, beta: Any, gamma: Any, axis: int = ..., epsilon: float = ...): ...
def concatenate(tensors: Any, axis: int = ...): ...
def reshape(x: Any, shape: Any): ...
def permute_dimensions(x: Any, pattern: Any): ...
def resize_images(x: Any, height_factor: Any, width_factor: Any, data_format: Any, interpolation: str = ...): ...
...
class EagerExecutionFunction:
    name: Any = ...
    def __init__(self, inputs: Any, outputs: Any, updates: Optional[Any] = ..., name: Optional[Any] = ...) -> None: ...
    def __call__(self, inputs: Any): ...

def function(inputs: Any, outputs: Any, updates: Optional[Any] = ..., name: Optional[Any] = ..., **kwargs: Any): ...
def gradients(loss: Any, variables: Any): ...
def stop_gradient(variables: Any): ...
def rnn(step_function: Any, inputs: Any, initial_states: Any, go_backwards: bool = ..., mask: Optional[Any] = ..., constants: Optional[Any] = ..., unroll: bool = ..., input_length: Optional[Any] = ..., time_major: bool = ..., zero_output_for_mask: bool = ...): ...
...
def conv2d_transpose(x: Any, kernel: Any, output_shape: Any, strides: Any = ..., padding: str = ..., data_format: Optional[Any] = ..., dilation_rate: Any = ...): ...
...
def configure_and_create_distributed_session(distribution_strategy: Any) -> None: ...
def is_tpu_strategy(strategy: Any): ...
def cast_variables_to_tensor(tensors: Any): ...
def convert_inputs_if_ragged(inputs: Any): ...
def maybe_convert_to_ragged(is_ragged_input: Any, output: Any, nested_row_lengths: Any): ...

class ContextValueCache(weakref.WeakKeyDictionary):
    default_factory: Any = ...
    def __init__(self, default_factory: Any) -> None: ...
    def __getitem__(self, key: Any): ...
    def setdefault(self, key: Optional[Any] = ..., default: Optional[Any] = ..., kwargs: Optional[Any] = ...): ...
