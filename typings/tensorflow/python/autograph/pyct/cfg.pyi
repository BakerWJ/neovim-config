...
class GraphBuilder:
    ...
    def add_exit_node(self, ast_node: Any, section_id: Any, guards: Any): ...
    def add_continue_node(self, ast_node: Any, section_id: Any, guards: Any) -> None: ...
    def connect_raise_node(self, node: Any, except_guards: Any) -> None: ...
    ...
    def enter_except_section(self, section_id: Any) -> None: ...
