...
from tensorflow.python.autograph.utils import ag_logging as ag_logging, compat_util as compat_util, misc as misc, tensors as tensors
...
from tensorflow.python.ops import control_flow_ops as control_flow_ops, math_ops as math_ops, tensor_array_ops as tensor_array_ops
...
def for_stmt(iter_: Any, extra_test: Any, body: Any, get_state: Any, set_state: Any, symbol_names: Any, opts: Any) -> None: ...
def while_stmt(test: Any, body: Any, get_state: Any, set_state: Any, symbol_names: Any, opts: Any) -> None: ...
