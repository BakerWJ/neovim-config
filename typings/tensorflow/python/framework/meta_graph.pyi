...
def strip_graph_default_valued_attrs(meta_graph_def: Any) -> None: ...
...
def export_scoped_meta_graph(filename: Optional[Any] = ..., graph_def: Optional[Any] = ..., graph: Optional[Any] = ..., export_scope: Optional[Any] = ..., as_text: bool = ..., unbound_inputs_col_name: str = ..., clear_devices: bool = ..., saver_def: Optional[Any] = ..., clear_extraneous_savers: bool = ..., strip_default_attrs: bool = ..., save_debug_info: bool = ..., **kwargs: Any): ...
