...
def run_distribute_coordinator(worker_fn: Any, strategy: Any, eval_fn: Optional[Any] = ..., eval_strategy: Optional[Any] = ..., mode: Any = ..., cluster_spec: Optional[Any] = ..., task_type: Optional[Any] = ..., task_id: Optional[Any] = ..., session_config: Optional[Any] = ..., rpc_layer: str = ...): ...
