...
class CheckpointSaverHook(session_run_hook.SessionRunHook):
    def __init__(self, checkpoint_dir: Any, save_secs: Optional[Any] = ..., save_steps: Optional[Any] = ..., saver: Optional[Any] = ..., checkpoint_basename: str = ..., scaffold: Optional[Any] = ..., listeners: Optional[Any] = ..., save_graph_def: bool = ...) -> None: ...
    def begin(self) -> None: ...
    def after_create_session(self, session: Any, coord: Any) -> None: ...
    def before_run(self, run_context: Any): ...
    def after_run(self, run_context: Any, run_values: Any) -> None: ...
