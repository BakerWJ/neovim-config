...
def checkpoint_exists_internal(checkpoint_prefix: Any): ...
...
class CheckpointManager:
    def __init__(self, checkpoint: Any, directory: Any, max_to_keep: Any, keep_checkpoint_every_n_hours: Optional[Any] = ..., checkpoint_name: str = ..., step_counter: Optional[Any] = ..., checkpoint_interval: Optional[Any] = ..., init_fn: Optional[Any] = ...) -> None: ...
    @property
    def directory(self): ...
    @property
    ...
    @property
    def checkpoint(self): ...
    def save(self, checkpoint_number: Optional[Any] = ..., check_interval: bool = ...): ...
