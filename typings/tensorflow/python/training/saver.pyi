...
class Saver:
    ...
    def save(self, sess: Any, save_path: Any, global_step: Optional[Any] = ..., latest_filename: Optional[Any] = ..., meta_graph_suffix: str = ..., write_meta_graph: bool = ..., write_state: bool = ..., strip_default_attrs: bool = ..., save_debug_info: bool = ...): ...
    def export_meta_graph(self, filename: Optional[Any] = ..., collection_list: Optional[Any] = ..., as_text: bool = ..., export_scope: Optional[Any] = ..., clear_devices: bool = ..., clear_extraneous_savers: bool = ..., strip_default_attrs: bool = ..., save_debug_info: bool = ...): ...
...
def export_meta_graph(filename: Optional[Any] = ..., meta_info_def: Optional[Any] = ..., graph_def: Optional[Any] = ..., saver_def: Optional[Any] = ..., collection_list: Optional[Any] = ..., as_text: bool = ..., graph: Optional[Any] = ..., export_scope: Optional[Any] = ..., clear_devices: bool = ..., clear_extraneous_savers: bool = ..., strip_default_attrs: bool = ..., save_debug_info: bool = ..., **kwargs: Any): ...
