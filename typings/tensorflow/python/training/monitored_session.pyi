...
class Scaffold:
    def __init__(self, init_op: Optional[Any] = ..., init_feed_dict: Optional[Any] = ..., init_fn: Optional[Any] = ..., ready_op: Optional[Any] = ..., ready_for_local_init_op: Optional[Any] = ..., local_init_op: Optional[Any] = ..., summary_op: Optional[Any] = ..., saver: Optional[Any] = ..., copy_from_scaffold: Optional[Any] = ..., local_init_feed_dict: Optional[Any] = ...): ...
    def finalize(self): ...
    @property
    def init_fn(self): ...
    @property
