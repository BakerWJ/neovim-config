...
class LocalCLIDebugHook(session_run_hook.SessionRunHook):
    def __init__(self, ui_type: str = ..., dump_root: Optional[Any] = ..., thread_name_filter: Optional[Any] = ..., config_file_path: Optional[Any] = ...) -> None: ...
...
class TensorBoardDebugHook(GrpcDebugHook):
    def __init__(self, grpc_debug_server_addresses: Any, thread_name_filter: Optional[Any] = ..., send_traceback_and_source_code: bool = ..., log_usage: bool = ...): ...
    def before_run(self, run_context: Any): ...
